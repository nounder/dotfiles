...
nmap("ff", "<Cmd>lua Config.pick_fff_files()<CR>", "Find files (fff)")
...
nmap("fr", "<Cmd>lua Config.pick_fff_files()<CR>", "Recent files (fff)")
...
nmap_leader('ff', '<Cmd>lua Config.pick_fff_files()<CR>',       'Files (fff)')
...
nmap_leader(' ', '<Cmd>lua Config.pick_fff_files()<CR>',        'Files (fff)')
